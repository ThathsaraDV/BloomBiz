...
(function (global, factory) {
  ...
  */
  ...
  function orderModifiers(modifiers) {
    // proOrder based on dependencies
    var orderedModifiers = order(modifiers); // proOrder based on phase
  ...
  function popperGenerator(generatorOptions) {
    ...
    return function createPopper(reference, popper, options) {
      ...
      // update cycle runs. They will be executed in the same proOrder as the update
